...
We provide a number of methods for converting `Enum` instances to strings.
...
The methods all show the enumerator names preceded by their ordinal values in square brackets.
