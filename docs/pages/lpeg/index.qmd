...
The `lulu.xpeg` module *extends* the standard`lpeg` module with predefined patterns and useful functions.
...
These patterns and methods can be used on a stand-alone basis.
