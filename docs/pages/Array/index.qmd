...
{Array.__name}              | A piece of string metadata that is set to "Array" in the base class.
...
{Array.delete}              | Efficiently deletes the a range of elements from an `Array`.
...
Method                      | Brief Description
--------------------------- | ---------------------------------------------------------------------
{Array.drop}                | Returns a new `Array` that is a copy with a range of elements removed.
{Array.drop_duplicates}     | Returns a new `Array` that contains only the non-duplicated elements.
{Array.drop_if}             | Returns a new `Array` that is a copy without any elements that pass a predicate test.
...
Method                      | Brief Description
--------------------------- | ---------------------------------------------------------------------
{Array.fold}                | Returns a new `Array` which is the result of "folding" a function over an `Array`.
...
Method                      | Brief Description
--------------------------- | --------------------------------------------------------------------
{Array.map}                 | Returns a new `Array` which is the result of applying a function to each element.
...
Method                      | Brief Description
--------------------------- | ---------------------------------------------------------------------
{Array.flatten}             | Returns a new `Array` which is a flattened version of this one.
